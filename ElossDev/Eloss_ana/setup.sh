...
source /seaquest/users/apun/abi_project/eloss_work/e1039_pr.121/core-inst/this-e1039.sh
...
if [ ${HOSTNAME:0:13} != 'spinquestgpvm' ] ; then
    echo "!!CAUTION!!"
    echo "This ElossAna package does not support your computer ($HOSTNAME)."
